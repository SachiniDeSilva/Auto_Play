...
class Weather_4 extends StatefulWidget {
  const Weather_4({super.key});

  @override
  State<Weather_4> createState() => _Weather_4State();
}

class _Weather_4State extends State<Weather_4> {
  bool _isPlay1 = true;
  bool _isPlay2 = true;
  bool _isPlay3 = true;
  bool _isPlay4 = true;
